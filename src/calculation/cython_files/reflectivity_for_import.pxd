...
# specified in the 'setup.py' file. However, the .so file cannot have the same name as the .pyx file (this causes
# an error because Cython confuses the two files). Hence, the .pxd file must also have a different name than the
# .pyx file.
